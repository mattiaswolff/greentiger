...
class Task {
  ...
  public function upsert () {
	...
	foreach (split(" ", strtolower($this->type)) as $var) {
		$this->keywords[] = $var;
	}
    ...
    'update' => array('createdBy' => $this->createdBy, 'createdDate' => $this->createdDate, 'keywords' => $this->keywords, 'definition' => $this->definition, 'comments' => $this->comments, 'likes'=> $this->likes, 'dislikes'=> $this->dislikes, 'rating'=> $this->rating, 'tags' => $this->tags, 'info'=> $this->info),
    'new' => true,   
    'upsert' => true,
    'fields' => array( '_id' => 1 )));
