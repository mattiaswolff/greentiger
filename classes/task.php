  ...
  //Properties
    ...
    function get($intObjectsPerPage = 10, $intPage = 1, $arrObjectId = null, $strSearch) {
        ...
        elseif ($arrObjectId != null) {
            if ($strSearch != '') {
                $objResults[0] = $db->tasks->find(array('$and' => array(array("_id" => array('$in' => $arrObjectId)), array("keywords" => array('$in' => $arrSearch)))))->sort(array("_id" => -1))->limit($intLimit)->skip($intSkip);
