...
<body id="home">
    <section>
        User
                ...
                <span onClick=<?php echo (!isset($_GET['userId'] ? '"' . "submitFormJSON('http://ec2-79-125-49-128.eu-west-1.compute.amazonaws.com/greentiger/api/user.php', 'POST')" . '"' : '"' . "submitFormJSON('http://ec2-79-125-49-128.eu-west-1.compute.amazonaws.com/greentiger/api/user.php', 'PUT')" . '"' ; ?>>Save user</span>
    <section>
        Definitions12
    			<form id="definitions">
				</form>
