...
<body id="home">
    <section>
        User
                ...
                <span onClick=<?php echo (isset($_GET['userId']) ? '' . 'submitFormJSON("http://ec2-79-125-49-128.eu-west-1.compute.amazonaws.com/greentiger/api/user.php", "PUT")' . '' : '' . 'submitFormJSON("http://ec2-79-125-49-128.eu-west-1.compute.amazonaws.com/greentiger/api/user.php", "POST")' . '') ?>>Save user</span>
    </section>
    <section>
        Definitions
    			<form id="definitions">
