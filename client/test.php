                ...
                * ============ */
                ...
                success: function(json) {
                    $.each(json.results[0].elements, function(key, value) {
                        arrHTML.push('<div class="control-group"><label class="control-label" for="' + value.id + '">' + value.id + ' <i name="' + value.id + '" class="icon-edit" data-toggle="modal" href="#myModal"></i> <a class="close" data-dismiss="alert">×</a></label><div class="controls">');
                        switch (value.type) {
                        ...
                        arrHTML.push('<p class="help-block">' + value.description + '</p></div></div>');
                    });
                }
                });
