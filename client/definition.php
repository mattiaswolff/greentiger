...
<body id="home">
    <section>
        ...
        <?php if (!isset($_GET['definitionId'])) {
            echo '<span onClick="' . "submitFormJSON('http://ec2-79-125-49-128.eu-west-1.compute.amazonaws.com/greentiger/api/users/" . $_GET['userId'] . "/definitions', 'POST')" . '">Save</span>';
        }
        else {
            echo '<span onClick="' . "submitFormJSON('http://ec2-79-125-49-128.eu-west-1.compute.amazonaws.com/greentiger/api/users/" . $_GET['userId'] . "/definitions/" . $_GET['definitionId'] . "', 'PUT')" . '">Save</span>';
        } ?>
        <br/>
