...
if (isset($_SESSION['userId'])) {
    ...
    $objUser->upsert();
    $strRedirectUri = (isset($_SESSION['redirectUri']) ? $_SESSION['redirectUri'] : "http://ec2-79-125-49-128.eu-west-1.compute.amazonaws.com/greentiger/client/dashboard.php?userId=me");  
