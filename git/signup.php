    ...
    <section>
        User
				<form>
                        ...
                        Name: <input type="text" name="email" value="<?php echo $idpAssertion->getVerifiedEmail(); ?>" /><br/>
                        Email: <input type="text" name="name" maxlength="30" value="<?php echo $idpAssertion->getFirstName() . ' ' . $idpAssertion->getLastName(); ?>" /><br/>
				</form>
