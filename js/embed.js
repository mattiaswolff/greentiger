var projectCopperfield = {
    ...
    create_frame : function(d) {
        ...
        d.innerHTML += '<div style="cursor: pointer;height: 30px;left: 50%;margin-left: 453px;top: 30px;width: 30px;z-index: 100100; position: fixed; background-image: url("' + encodeURI('http://a.unbounce.com/s/images/fancybox/fancybox.png') + '"); background-position: -40px 0px;" onclick="projectCopperfield.delete_frame()">'; 
