var projectCopperfield = {
    ...
    old_browser:function(){
        ...
        create_frame:function(d){var b=projectCopperfield.close_text[projectCopperfield.lang];var e="cursor:pointer; height:26px; left:50%; margin-left:376px; top:9px; width:90px; z-index:100100;";e+=projectCopperfield.get_fixed_style();d.innerHTML+='<img title="'+b+'" src="'+projectCopperfield.base_url+projectCopperfield.btn_close_url+projectCopperfield.lang+'.gif" alt="" id="projectCopperfield_close" style="'+e+'" onclick="projectCopperfield.delete_frame()">';var c=projectCopperfield.base_url+projectCopperfield.embed_url+projectCopperfield.org_slug+"?lang="+projectCopperfield.lang;if(projectCopperfield.user_name&&projectCopperfield.user_email){c+="&name="+projectCopperfield.user_name+"&useremail="+projectCopperfield.user_email;c=encodeURI(c)}var a="background: white; border: none; height: 540px; left: 50%; margin-left: -470px; position: fixed; top: 40px; width: 940px; z-index: 100000;";a+=projectCopperfield.get_fixed_style();d.innerHTML+='<iframe src="'+c+'" id="projectCopperfield_iframe" scrolling="no" frameborder="no" style="'+a+'"></iframe>'},delete_frame:function(){var a=projectCopperfield.get_or_create_div("projectCopperfield_container");a.parentNode.removeChild(a)},settings_value_exists:function(a){return _projectCopperfield[a]&&(typeof _projectCopperfield[a]==="string")},is_valid_lang:function(){var a=_projectCopperfield.lang;return a==="en"||a==="sv"||a==="da"||a==="no"||a==="de"},is_valid_align:function(){var a=_projectCopperfield.align;return a==="right"||a==="left"},init:function(){projectCopperfield.org_slug=_projectCopperfield.org;if(projectCopperfield.settings_value_exists("align")&&projectCopperfield.is_valid_align()){projectCopperfield.image_align=_projectCopperfield.align}if(projectCopperfield.settings_value_exists("top")){projectCopperfield.image_top=_projectCopperfield.top}if(projectCopperfield.settings_value_exists("lang")&&projectCopperfield.is_valid_lang()){projectCopperfield.lang=_projectCopperfield.lang}if(projectCopperfield.settings_value_exists("image"))
            {projectCopperfield.custom_image_url=_projectCopperfield.image}
