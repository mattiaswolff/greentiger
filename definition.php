				...
				<section class = "app-panel theme-standard">
					...
					<section class="content">
						...
						<div class="definition">
							<h2 class="lable text heading">Definition</h2>
							<p class="lable text feature">Create a new definition or edit one of your existing ones.</p>
							<div class="content-box">
								<form action="./scripts/manageDefinition.php" method="post">
								<h2 class="lable text subheading"><?php if (isset($definition->name)){ echo $definition->name; echo '<input type="text" name="name" value="' . $definition->name .'" hidden />'; } else { echo '<input type="text" name="name" placeholder="Definition title" />'; } ?></h2>
								<p class="lable text body"><textarea name="description">Description of this definition.</textarea></p>
									<fieldset id="form">
